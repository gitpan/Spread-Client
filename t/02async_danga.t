...
SKIP: {
    my $have_danga = eval { require Danga::Socket; 1; };

    skip 'SPREAD_NAME environment variable not defined or we are missing Danga::Socket', 7
        unless $ENV{SPREAD_NAME} and $have_danga;

    my $spread_name = $ENV{SPREAD_NAME};
